(function() {
	...
	sellorToolApp.constant('config', {
             ...
             */
            aes256: {
            	key: 'ZjE5YmFiM2ZiZGExNDJjNjhjOGYwMGY3',
        		encrypt: function(strPlain) {
        			if(!envs.prod.encrypt) return strPlain;
        			
        			if(strPlain != null && typeof strPlain == 'object') {
        				strPlain = JSON.stringify(strPlain);
        			}
        		...
        		decrypt: function(strEncoded) {
        			...
        			var test = '';
        			GibberishAES.size(256);
        			test = GibberishAES.aesDecrypt(strEncoded.enc, this.key);
        			try {
